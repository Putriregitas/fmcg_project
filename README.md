...
Project ini membangun pipeline ETL end-to-end untuk industri FMCG dengan arsitektur modern berbasis cloud, untuk mengintegrasikan data.

Tujuan utama pipeline ini adalah menghasilkan dataset yang clean, terstruktur, ter-partition, dan siap digunakan untuk analisis pada level Outlet dan SKU, sehingga dapat mendukung analisis distribusi, ketersediaan stok (Out-of-Stock), dan optimalisasi alokasi barang secara lebih akurat dan efisien.
